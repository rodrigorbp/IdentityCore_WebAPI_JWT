...
namespace WebApp.Identity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=IdentityCurso;Data Source=LAPTOP-4AI8F6G6\SQLEXPRESS";
            ...
            services.Configure<DataProtectionTokenProviderOptions>(
                optiions => optiions.TokenLifespan = TimeSpan.FromHours(3)
                );
